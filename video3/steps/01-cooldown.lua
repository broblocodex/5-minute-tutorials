-- Step 01 — Per-player cooldown
-- What: add a per-player cooldown so players can't instantly re-use the portal.
-- Why: prevents ping-pong loops and spam, especially in tight hub layouts.
