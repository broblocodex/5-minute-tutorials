-- Step 03 (Server) - Follow the Leader
-- What: Add a Follow behavior that stalks the requesting player instead of patrolling.
-- Why: Quick squad-follow mechanic before layering UI polish.
